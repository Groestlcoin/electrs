...
The server indexes the entire Groestlcoin blockchain, and the resulting index enables fast queries for any given user wallet,
 ...
 * [`txindex`](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch03.asciidoc#txindex) is not required for the Groestlcoin node
